...
## Full model
glm_m2 <- glm(formula = lands_rec ~ hypso_inte_Std + X_Ksmean_Std + rainfall_cat_Std + Densidad_Std + elev_mean_Std + slope_mean_Std + rel_mean_Std, family = poisson, data = df)
summary(glm_m2)
